...
In order to get both the simple and complex models working properly, we generated two environments for this project. The environment for the simple models can be created from the included [requirements.txt](https://github.com/PJMichaels/Chemistry-Capstone/blob/main/requirements.txt) file in this repository and by following instructions in [Pipeline_Setup.txt](https://github.com/PJMichaels/Chemistry-Capstone/blob/final/Pipeline_Setup.txt). 
